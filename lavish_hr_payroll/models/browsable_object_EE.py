...
class BrowsableObject_ee(object):
...
class ResultRules_ee(BrowsableObject_ee):
    def __getattr__(self, attr):
...
class InputLine_ee(BrowsableObject_ee):
...
class WorkedDays_ee(BrowsableObject_ee):
    """a class that will be used into the python code, mainly for usability purposes"""
...
class Payslips_ee(BrowsableObject_ee):
    """a class that will be used into the python code, mainly for usability purposes"""
